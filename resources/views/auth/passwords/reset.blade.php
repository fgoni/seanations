                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-4 flex flex-wrap">
                            ...
                            <div class="md:w-1/2 pr-4 pl-4">
                                <input id="email" type="email" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded{{ $errors->has('email') ? ' bg-red-dark' : '' }}" name="email" value="{{ $email ?? old('email') }}" required autofocus>
